"""Extract and cache MM-PSYCHE-style features for one FIV2 split.
  ...
  python -m bs_bigfive.mm.extract --split train --modalities audio,text,behavior
  python -m bs_bigfive.mm.extract --split train --modalities face --shard 0/6     # one of 6 parallel shards
  python -m bs_bigfive.mm.extract --split train --modalities face --merge         # merge shard files
