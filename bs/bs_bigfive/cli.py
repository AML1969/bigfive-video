...
def main(argv=None):
    ap = argparse.ArgumentParser(prog="bs", description=__doc__, formatter_class=argparse.RawDescriptionHelpFormatter)
    ...
    p.add_argument("--work-dir", default=None, help="where uploads and results are stored (default ~/bs/web_jobs)")
