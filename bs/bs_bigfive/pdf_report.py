...
class Report(FPDF):
    ...
    def footer(self):
        ...
        self.cell(0, 5, f"BS Big Five · стр. {self.page_no()}", align="R")
...
def build_pdf(report: dict, out_path: str | Path, explanation: dict | None = None, media: dict | None = None,
    ...
    # ---- explanations
    if explanation:
        pdf.h2("6. Вклад модальностей (Input×Gradient, своя модель)")
