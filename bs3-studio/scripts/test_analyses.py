"""Smoke test of the BS Profiler 3.0 analyses on one existing segment of a batch run.
...
from bs3.analyses.emotions_text import TextEmotion, dominant
from bs3.analyses.emotions_voice import VoiceEmotion
from bs3.analyses.face_expr import FaceExpression
from bs3.analyses.speech_stats import describe, stats_for, vocabulary
from bs3.translate import translate_sentences
