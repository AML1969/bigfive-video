...
C5 = ("Ось «на границе» — оценка лежит в зоне от 0.35 до 0.65, то есть отстоит от середины шкалы 0.5 меньше чем на "
...
C7_RU = ("Две системы обучены на разных данных и работают на разных шкалах, поэтому тип каждой посчитан по её "
         ...
         "речи); совпадение букв у двух систем — признак более надёжного вывода, расхождение — повод считать ось "
         "неустойчивой.")
